...
public class RolesReport {
	...
	public String getRolesReportData() throws IOException {
		  VelocityEngine ve = new VelocityEngine();
	        ...
	        String responseData = httpUtils.makeHttpCall("http://192.168.1.17:8080/istar/rest/principal/dashboard/3/get_all_courses_reports", "GET");
	...
	public String getRoleReportDetail(Integer courseId) throws IOException {
		  VelocityEngine ve = new VelocityEngine();
	        ...
	        HttpUtils httpUtils = new HttpUtils();
	        String responseData = httpUtils.makeHttpCall("http://192.168.1.17:8080/istar/rest/course/3/course_stats_performance/"+courseId, "GET");
	        JSONObject json =  new JSONObject(responseData);
